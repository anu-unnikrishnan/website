...
export default ({ data }) => (
            ...
            About me
                              ...
                              <a
                              css={css`
                              color: #FA8072;`} target="_blank" href="https://www.linkedin.com/in/anuunnikrishnan/">LinkedIn</a>
                              &nbsp; / &nbsp;
                              <a
                              css={css`
                              color: #FA8072;`} target="_blank"
                              ...
                              <a
                              css={css`
                              color: #FA8072;`} target="_blank" href="https://ora.ox.ac.uk/objects/uuid:8309d4e8-5f4c-4e86-9381-fcaf2f6626f1">PhD Thesis</a>
